...
A média da frequência gênica entre todas as linhas permanecerá igual à frequência inicial. Logo, $\bar{p} = p_0 = 0.4$ e $\bar{q} = q_0 = 0.6$, e as frequências genotípicas serão $p_0^2\ e\ q_0^2$.
