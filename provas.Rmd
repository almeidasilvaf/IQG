...
- **( ) Quando p=q, a media de uma população (em termos de desvio do ponto médio), depende tão somente dos heterozigotos.**

- **( ) Se p=1, a media referida no item a é igual ao próprio efeito aditivo "a".**

- **( ) Valor genético (A) é o valor associado ao genótipo do indivíduo.**

- **( ) Ação aditiva indica tão somente à ausência de dominância.**

- **( ) Dominância e epistasia são sinônimos que se referem à interação entre locos.**

- **( ) O Valor genético de um indivíduo (A) corresponde à soma dos efeitos médios dos genes que ele possui.**

- **( ) Quando a repetibilidade é alta indica que se ganha muito em eficiência utilizando medidas múltiplas dada a previsibilidade dos resultados.**

- **( ) A covariância entre grupos ou famílias eqüivale à Variância dentro de grupos ou famílias.**

- **( ) A substituição de um alelo desfavorável por outro favorável (a) será sempre positiva, independente da freq. gênica**
