...
Cruzamento: A_ x Aa &emsp; &emsp; Descendentes: 100% A_

Se o touro fosse homozigoto, teríamos AA x Aa, que resultaria em 50% AA : 50% Aa (todos mochos).
...
**c) Utilizando-se as freqüências gênicas observadas, quais seriam as freqüências genotípicas esperadas de acordo com a lei de Hardy-Weinberg?**
...
O teste resultou em um $\chi^2$ muito elevado, com valor de P < 0.05, indicando que a população está em desequilíbrio. O mesmo fato pode ser constatado pelo valor de D.
...
Para verificar a frequência de A no equilíbrio, vamos simular 100 gerações de cruzamento ao acaso e obter a frequência na geração 100.
