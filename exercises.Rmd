...
A frequência gênica média seria igual à frequência gênica inicial. Ou seja, sendo q o alelo mutante:
...
$$
\begin{aligned}
A_1A_1 &= p_0^2 + \sigma^2_q = 0.2 \times 0.03889258 = 0.007778516 \\
A_1A_2 &= 2p_0q_0 - \sigma^2_q = 2 \times 0.2 \times 0.8 - 0.03889258 = 0.2811074 \\
A_2A_2 &= q_0^2 + \sigma^2_q = 0.8 + 0.03889258 = 0.8388926
\end{aligned}
$$
